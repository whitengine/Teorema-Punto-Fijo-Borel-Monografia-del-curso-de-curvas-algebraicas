...
\begin{theorem}[Teorema de Lie-Kolchin]
...
\begin{proposition}
Si $\sigma$ es un automorfismo de $G$ que deja fijo todos los elementos de un subgrupo de Borel $B$, enntonces debe ser la identidad.
\end{proposition}
\begin{proof}
El morfismo
\begin{align*}
...
\end{align*}
envía $B$ en $1$, y por lo tanto se factoriza por la proyección al cociente $G \to G/B$....
...
....
\end{proof}
